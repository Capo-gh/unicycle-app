...
const getSafeZones = (university) => {
    return SAFE_ZONES_BY_UNIVERSITY[university] || DEFAULT_SAFE_ZONES;
};

// Legacy export for backward compatibility
const SAFE_ZONES = SAFE_ZONES_BY_UNIVERSITY['McGill University'];

module.exports = { SAFE_ZONES, SAFE_ZONES_BY_UNIVERSITY, getSafeZones };
