            ...
            <div className="bg-white border-b border-gray-200 overflow-x-auto">
                <div className="max-w-md mx-auto px-4">
                    <div className="flex gap-4 py-3">
                        {['All', 'Furniture', 'Textbooks', 'Electronics', 'Appliances'].map((cat) => (
                            <button
                                key={cat}
                                className={`px-4 py-1.5 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${cat === 'All'
